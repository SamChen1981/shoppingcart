...
<div class="banner-top">
    <div class="container">
        ...
        <h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="${pageContext.request.contextPath}/view/index">主页</a><label>/</label>注册</h3>
        <div class="clearfix"> </div>
    </div>
</div>
<!-- contact -->
    ...
    <div class="container">
        <form>
            <div class="col-md-6 login-do1 animated wow fadeInLeft" data-wow-delay=".5s">
                ...
                <div class="login-mail">
                    <input type="text" placeholder="昵称" required="" name="nick">
                </div>
                <div class="login-mail">
                    <input type="text" placeholder="电话" required="" name="tel">
                </div>
                <div class="login-mail">
                ...
                <div class="login-mail">
                    <input type="password" placeholder="重复密码" required="" name="userpwd1">
                </div>
            </div>
            <div class="col-md-6 login-do animated wow fadeInRight" data-wow-delay=".5s">
                ...
                <p>还没有登入？</p>
                <a href="${pageContext.request.contextPath}/view/login" class="hvr-sweep-to-top">登入</a>
            </div>
            <div class="clearfix"> </div>
        </form>
    </div>
...
<script type="text/javascript">
    $("#but").click(function(){
        var userpwd1 = $("input[name=userpwd]").val();
        var userpwd2 = $("input[name=userpwd1]").val();
        ...
        $.ajax({
            url:'${pageContext.request.contextPath}/user/user/add',
            data:senddata,
            dataType:'json',
            type:'post',
