...
<div class="banner-top">
    <div class="container">
        ...
        <h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="${pageContext.request.contextPath}/view/index">主页</a><label>/</label>产品<label>/</label>男装</h3>
        <div class="clearfix"> </div>
    </div>
</div>
<!--content-->
                ...
                <div class="product-head">
                    <div class="product-go">
                        <div class=" fashion-grid">
                            <a href="${pageContext.request.contextPath}/view/single"><img class="img-responsive " src="../images/pcc2.jpg" alt=""></a>
                    ...
                    <div class="product-go">
                        <div class=" fashion-grid">
                            <a href="${pageContext.request.contextPath}/view/single"><img class="img-responsive " src="../images/pcc3.jpg" alt=""></a>
