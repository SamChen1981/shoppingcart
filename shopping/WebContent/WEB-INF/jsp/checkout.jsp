                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="${pageContext.request.contextPath}/view/products">女装</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="${pageContext.request.contextPath}/view/products1">男装</a></li>
                                <li role="presentation" class="divider"></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="#">配件</a></li>
...
<div class="banner-top">
    <div class="container">
        ...
        <h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="${pageContext.request.contextPath}/view/login">主页</a><label>/</label>购物车</h3>
        <div class="clearfix"> </div>
    </div>
</div>
<!-- contact -->
    ...
    <div class="container">
        ...
        <table class="table animated wow fadeInLeft" data-wow-delay=".5s">
            <tr>
                ...
                <th class="t-head">单价</th>
                <th class="t-head">数量</th>
                <th class="t-head">总价</th>
            </tr>
            <tr class="cross">
                <td class="ring-in t-data">
                    <a href="${pageContext.request.contextPath}/view/single" class="at-in">
            ...
            <tr class="cross1">
                <td class="t-data ring-in"><a href="${pageContext.request.contextPath}/view/single" class="at-in"><img src="../images/pcc2.jpg" class="img-responsive" alt=""></a>
                    <div class="sed">
                        <h5>Sed ut perspiciatis unde</h5>
                    </div>
                    <div class="clearfix"> </div>
            ...
            <tr class="cross2">
                <td class="t-data ring-in"><a href="${pageContext.request.contextPath}/view/single" class="at-in"><img src="../images/pcc1.jpg" class="img-responsive" alt=""></a>
                    <div class="sed">
                        <h5>Sed ut perspiciatis unde</h5>
                    </div>
                    <div class="clearfix"> </div>
        ...
        <div class=" cart-total">
            ...
            <a href="${pageContext.request.contextPath}/view/single">结算</a>
